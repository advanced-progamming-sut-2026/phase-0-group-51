...
//    public minigames(PvzGame game, minigameType chapter) {
//        super(game);
//        this.minigameType = chapter;
//        buildUi();
//    }
//
...
//        backgroundTexture = new Texture(Gdx.files.internal(getBackgroundForChapter(minigameType)));
...
//        addEdgeDecorations();
//
//        Drawable bgStatueDrawable = safeRegion(getBackgroundStatueId(minigameType));
//        if (bgStatueDrawable != null) {
//            Image bgStatue = new Image(bgStatueDrawable);
//            float bgScale = getBackgroundStatueScale(minigameType);
...
//
//
//    private minigames.DecoConfig[] getEdgeDecoConfigs(minigameType type) {
//        switch (type) {
//            case BEGHOULED:
//                return new ChapterMapScreen.DecoConfig[]{
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_EGYPT_ISLAND25", 60f, 120f, 0.2f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_EGYPT_ISLAND16", 1400f, 100f, 0.4f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND23", -50f, 80f, 1.2f, 0.8f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND22", 1100f, 50f, 1.2f, 0.8f)
//                };
//            case I_ZOMBIE:
//                return new ChapterMapScreen.DecoConfig[]{
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_ICEAGE_ISLAND24", 600f, 400f, 0.5f, 0.5f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_ICEAGE_ISLAND23", 1400f, 200f, 0.5f, 0.6f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND23", -50f, 80f, 1.2f, 0.8f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND22", 1100f, 50f, 1.2f, 0.8f)
//                };
//            case WALLNUT:
//                return new ChapterMapScreen.DecoConfig[]{
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_BEACH_ISLAND13", 600f, 300f, 0.5f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_BEACH_ANIM1_ANIM1_283X291", 1200f, 180f, 0.5f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND23", -50f, 80f, 1.2f, 0.8f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND22", 1100f, 50f, 1.2f, 0.8f)
//                };
//            case VASE_BREAKER:
//                return new ChapterMapScreen.DecoConfig[]{
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_DARK_ISLAND21", 600f, 100f, 0.5f, 0.3f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_DARK_ANIM6_ANIM6_649X585", 1650f, 250f, 0.5f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND23", -50f, 80f, 1.2f, 0.8f),
//                        new ChapterMapScreen.DecoConfig("IMAGE_WORLDMAP_COWBOY_ISLAND22", 1100f, 50f, 1.2f, 0.8f)
//                };
//            default:
//                return new ChapterMapScreen.DecoConfig[]{
//                        new ChapterMapScreen.DecoConfig("PLACEHOLDER_DEFAULT_DECO_LEFT", -20f, 150f, 1.0f, 0.4f),
//                        new ChapterMapScreen.DecoConfig("PLACEHOLDER_DEFAULT_DECO_RIGHT", 1650f, 250f, 1.0f, 0.4f)
//                };
//        }
//    }
//
//    private void addEdgeDecorations() {
//        ChapterMapScreen.DecoConfig[] decos = getEdgeDecoConfigs(minigameType);
//        for (ChapterMapScreen.DecoConfig deco : decos) {
...
//    }
//
//    private String getBackgroundForChapter(minigameType chapter) {
//        return "assets/backgrounds/adventure.jpeg";
//    }
//
//    private String getBackgroundStatueId( minigameType minigameType) {
//        switch (minigameType) {
//            case VASE_BREAKER:
...
//    }
//
//    private float getBackgroundStatueScale( minigameType chapter) {
//        switch (chapter) {
//            case ZOMBOTANY:
//                return 0.8f;
//            case VASE_BREAKER:
...
//    }
//
//    private ChapterMapScreen.NodeConfig getNodeConfig(minigameType type, int levelNum) {
//        switch (type) {
//            case BEGHOULED:
//                if (levelNum == 1) return new ChapterMapScreen.NodeConfig(0.70f, 0.5f, 0.70f, 0.45f);
//                if (levelNum == 2) return new ChapterMapScreen.NodeConfig(0.75f, 0.5f, 0.50f, 0.75f);
//                if (levelNum == 3) return new ChapterMapScreen.NodeConfig(0.75f, 0.5f, 0.50f, 0.75f);
//                return new ChapterMapScreen.NodeConfig(0.75f, 0.5f, 0.50f, 0.75f);
//
//            case I_ZOMBIE:
//                if (levelNum == 1) return new ChapterMapScreen.NodeConfig(0.40f, 0.5f, 0.62f, 0.48f);
//                if (levelNum == 2) return new ChapterMapScreen.NodeConfig(0.55f, 0.5f, 0.48f, 0.80f);
//                if (levelNum == 3) return new ChapterMapScreen.NodeConfig(0.55f, 0.5f, 0.48f, 0.80f);
//                return new ChapterMapScreen.NodeConfig(0.55f, 0.5f, 0.48f, 0.80f);
//
//            case VASE_BREAKER:
//                if (levelNum == 1) return new ChapterMapScreen.NodeConfig(0.32f, 0.5f, 0.60f, 0.45f);
//                if (levelNum == 2) return new ChapterMapScreen.NodeConfig(0.35f, 0.5f, 0.55f, 0.78f);
//                if (levelNum == 3) return new ChapterMapScreen.NodeConfig(0.35f, 0.5f, 0.50f, 0.79f);
//                return new ChapterMapScreen.NodeConfig(0.35f, 0.5f, 0.55f, 0.78f);
//
//            case ZOMBOTANY:
//                if (levelNum == 1) return new ChapterMapScreen.NodeConfig(0.55f, 0.5f, 0.78f, 0.33f);
//                if (levelNum == 2) return new ChapterMapScreen.NodeConfig(0.65f, 0.5f, 0.50f, 0.75f);
//                if (levelNum == 3) return new ChapterMapScreen.NodeConfig(0.65f, 0.5f, 0.50f, 0.75f);
//                return new ChapterMapScreen.NodeConfig(0.65f, 0.5f, 0.50f, 0.75f);
//
//            default:
//                return new ChapterMapScreen.NodeConfig(0.65f, 0.5f, 0.50f, 0.75f);
//        }
...
//        ChapterMapScreen.NodeConfig cfg = getNodeConfig(minigameType, levelNum);
//
...
//        minigames.NodeConfig cfg = getNodeConfig(minigameType, levelNum);
//
